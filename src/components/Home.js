            ...
            <div className="home_container container grid">
                <div className="home_content grid">
                    <div className="home_social">
                        <a href="https://www.linkedin.com/in/shresth-jain-6b14a6201/" className="home_social-icon" target="_blank">
                            <FaLinkedin />
                        </a>
                        <a href="https://leetcode.com/u/shresthjain/" className="home_social-icon" target="_blank">
                            <SiLeetcode />
                        </a>
                        <a href="https://www.instagram.com/shresthjain14/" className="home_social-icon" target="_blank">
                            <FaInstagram />
                        </a>
                        <a href="https://github.com/shresthjain14" className="home_social-icon" target="_blank">
                            <FaGithub />
                        </a>
                    ...
                    <div className="home_data">
                        ...
                        <h1 className="heading-name">
                            <strong className="main-name">Shresth Jain</strong>
                        </h1>
