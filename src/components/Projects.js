...
import IMG3 from "../assets/WhatsApp Image 2024-08-14 at 13.56.52_939f0a2a.jpg";
import IMG4 from "../assets/WhatsApp Image 2024-08-14 at 13.20.22_ec923140.jpg";
...
const Portfolio = () => {
    const soloProjects = [
        ...
        },
        {
            ...
            title: "Task-Master",
            img: IMG3,
            description:"It involves developing a work management tool with role-based access control, where admins can manage projects, assign tasks, and monitor progress.",
            technologies: "HTML | CSS | Javascript | React Js | Node.js | Express.js",
            link: "https://taskmaster-unr0.onrender.com/",
